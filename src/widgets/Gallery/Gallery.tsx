 ...
 */
export interface GalleryProps<T = MediaItem> {
...
/**
 * Gallery - Slot-based grid component for displaying media items
 *
 * Renders items in a responsive CSS Grid masonry layout with slots for
 * toolbars, custom cards, and empty states. Replaces the HOC pattern
 * with composable hooks and render props.
 *
 * @example
 * ```tsx
 ...
 * ```
 */
const Gallery = memo(<T extends { id: string } = MediaItem>({
    items,
    renderCard,
...
(Gallery as any).displayName = 'Gallery';
